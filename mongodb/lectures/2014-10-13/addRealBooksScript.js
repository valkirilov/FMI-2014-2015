...
book10 = {
	author: "Suzanne Collins",
	title: "The Hunger Games: The Mockingjay",
	pages: 426,
	tags: ["adventure", "apocalyptic", "science fiction", "drama"],
	copiesInStock: {
		Sofia: 57, Plovdiv: 38, Burgas: 181, Ruse:39, Varna: 13
	},
	publisher: "Rhinebow Ltd",
	publishDate: new Date('Aug 24, 2010'),
	translatedInto: ["Bulgarian"]
}

db.books.insert([book1,book2,book3,book4,book5,book6,book7,book8,book9,book10]);